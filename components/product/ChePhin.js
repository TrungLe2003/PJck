...
const product3Number = +localStorage.getItem("product3Number");
const productInforFrame3 = JSON.parse(
  localStorage.getItem("frame3-item") || "[]"
);
const findProduct = productInforFrame3.find(
  (item) => +item.Id === product3Number
);
...
if (findProduct) {
  detail.innerHTML = `
    <div class="banner">
      ...
      <a href="../product/product.html">${findProduct.frame3CateItemTitle}</a>
    </div>
    <div class="frame1">
      ...
      <div class="frame1-act">
        <div class="name-product">
          <h1>${findProduct.frame3CateItemTitle}</h1>
        </div>
        <div class="frame1-product-infor">
          <div class="product-infor_card1">
            <div class="product-property">
              <h2>Đặc tính</h2>
              <ul>
              ${findProduct.frame3ProductDescribe}
              </ul>
            </div>
            <div class="product-rate">
              <p>${findProduct.frame3ProductCardScore}</p>
          ...
          <div class="product-infor_card2">
            <div class="product-infor_add-to-cart">
              <div class="product-infor_row product-infor-price">
                <span class="product-infor_total-price">${findProduct.frame3ProductCardPrice}</span>
                <del>100.000đ</del>
              </div>
    ...
    <div class="frame2">
      ...
      ${findProduct.frame3ProductMoreDescribe}
      </div>
    </div>
  `;
} else {
